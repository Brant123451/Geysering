...
{{
    ...
    {{
        ...
        // transport sigma with upwind intensity fluxes (phi_air*s) scaled so
        // no cell loses more tagged mass than it holds (conservative
        // positivity).  Mild s>1 allowed when alpha*rho shrinks.  No phiVol
        // reconstruction and no cell clip of sigma.
