...
water/air interface while the production 3-D centre-plane run continues.  The
x-z outline uses the paper dimensions and is extruded one cell through 0.01 m.
"""
