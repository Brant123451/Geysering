#!/usr/bin/env python3
"""Render the real OpenFOAM quasi-2-D alpha.water field for Liu2020 B3.
...
the sampled thin-domain OpenFOAM volume field.
"""
...
def render_frame(vtp: Path, output: Path) -> dict[str, float | int | str]:
    ...
    ax.set_ylabel("z (m)")
    ax.set_title(
        "Liu2020 B3 — real OpenFOAM quasi-2-D front-view water–air field\n"
