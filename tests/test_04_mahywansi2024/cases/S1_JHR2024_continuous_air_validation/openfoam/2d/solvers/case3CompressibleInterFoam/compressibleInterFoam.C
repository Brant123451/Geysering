...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        // Advance the VOF equation once over this physical time interval.
        // The following PIMPLE loop only iterates U, T, and p over the same
        // accepted alpha/rhoPhi state; it must not advance alpha again.
