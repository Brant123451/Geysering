...
case3_require_runtime_gate "coarse Stage 1"
set +eu
...
echo "Stage-1 segment finished; stability audit must create STAGE1_COMPLETE and STAGE1_ACCEPTED."
