...
case3_require_runtime_gate "refined smoke"
...
grep -Eq 'default[[:space:]]+CrankNicolson[[:space:]]+0\.9;' system/fvSchemes
grep -Eq 'nAlphaSubCycles[[:space:]]+1;' system/fvSolution
