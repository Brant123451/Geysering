...
That setting is rejected.  Raising only `CASEB_N_NON_ORTHOGONAL_CORRECTORS` from
...
CASEB_HYDROSTATIC_INITIALIZATION=analytic|discrete
CASEB_HYDROSTATIC_CORRECTORS=5|10  # only with discrete
