#!/usr/bin/env python3
"""Fail-fast paper-contract audit for the prepared B-H3 2D case."""
...
def main() -> None:
    ...
    cfg = json.loads((HERE / "case_config.json").read_text())
    ...
    checks = {
        ...
        "Dr_0p026": close(g["riser_inner_diameter"], 0.026),
    ...
    required_text = {
        "system/controlDict": ["endTime         13", "maxCo           0.25"],
    ...
    checks["area_equivalent_width_0p01352"] = close(
        mesh_stats["planar_mapping_m"]["riser_width"], 0.01352
    )
