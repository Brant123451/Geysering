...
VARIANTS = (
    ...
    Variant("base_nominal", "core", mesh="prism_atmosphere", valve="0.2", n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
    Variant("refined_nominal", "core", mesh="refined", valve="0.2", n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
    Variant(
        "dt_fine",
        "sensitivity",
        mesh="prism_atmosphere",
    ...
    Variant("valve_0p2", "sensitivity", mesh="prism_atmosphere", valve="0.2", n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
    Variant("valve_0p5", "sensitivity", mesh="prism_atmosphere", valve="0.5", n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
    Variant("interface_diffuse", "sensitivity", mesh="prism_atmosphere", valve="0.2", c_alpha=0.5, n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
    Variant("interface_sharp", "sensitivity", mesh="prism_atmosphere", valve="0.2", c_alpha=2.0, n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
    Variant(
        "initial_sharp",
        "sensitivity",
        mesh="prism_atmosphere",
    ...
    Variant("sigma_zero", "sensitivity", mesh="prism_atmosphere", valve="0.2", surface_tension=0.0, n_hat_gradient_scheme="least-squares", atmosphere_pressure_boundary="wave-transmissive"),
)
