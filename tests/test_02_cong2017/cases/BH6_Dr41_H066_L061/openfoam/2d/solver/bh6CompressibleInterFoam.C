/* OpenFOAM v2512 compressibleInterFoam derivative used for Cong B-H6.
   It retains the standard compressible VOF transport and adds the audited
   total-sensible-enthalpy equation plus a passive opening-valve loss. */
...
int main(int argc, char *argv[])
{
    argList::addNote
    (
        "Two-phase compressible VOF solver with passive B-H6 valve resistance"
    );
