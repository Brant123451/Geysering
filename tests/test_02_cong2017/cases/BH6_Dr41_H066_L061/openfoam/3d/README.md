...
at the initial free surface and physical rim.  This removes the non-physical
CSF curvature generated by an irregular tetrahedral stencil at an exactly flat
interface.  The physical riser still ends at `z=1.825 m`; the box above it is
external air, not an artificially lengthened riser.
